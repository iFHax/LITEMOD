...
vless_manage() {
    local mode=$1
    local user masaaktif exp hariini uuid domain domainn tls none vlesslink1 vlesslink2 vlesslink3 vlesslink4 vlesslink5 vlessyamltls vlessyamlntls CLIENT_EXISTS CLIENT_NUMBER
...
echo -e "\033[0;34m------------------------------------\033[0m"
echo ""
echo -e " [\e[36m 01 \e[0m] Trial XRay VLess WS & gRPC"
echo -e " [\e[36m 02 \e[0m] Add XRay VLess WS & gRPC"
echo -e " [\e[36m 03 \e[0m] Delete XRay VLess WS & gRPC"
echo -e " [\e[36m 04 \e[0m] Renew XRay VLess WS & gRPC"
echo -e " [\e[36m 05 \e[0m] Check User Login XRay Vless WS & gRPC"
